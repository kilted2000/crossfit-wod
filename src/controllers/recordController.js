...
const getOneRecord = (req, res) => {
  ...
  try {
    const workout = recordService.getOneRecord(workoutId);
...
const { getRecordForWorkout: getRecordForWorkoutFromDB } = require("../database/Record");
...
const getRecordForWorkout = (req, res) => {
  ...
  try {
    const record = getRecordForWorkoutFromDB(workoutId);
...
const updateOneRecord = (req, res) => {
  ...
  try {
    const updatedRecord = recordService.updateOneRecord(workoutId, body);
